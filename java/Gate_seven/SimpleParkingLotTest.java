...
public class SimpleParkingLotTest {
    ...
    public void setUp() {
        ...
        for (int count = 0; count < simpleparkinglot.slots.length; count++) {
            simpleparkinglot.slots[count] = 0;
        }
    }

    @Test
    public void testParkAutoParksFirstAvailableSlot() {
        simpleparkinglot.parkAuto();
        assertEquals(1, simpleparkinglot.slots[0]);
    }
