//1.You are to simulate a simple parking lot
//with 20 slots.
//2.Each slot is either empty (0) or occupied
//by a car number (1).
// 3.A car can enter the parking lot if there’s a
//free slot from left to right( from slot 1 - 20 )
//4.for by indicating a slot number that is still
//empty.
//5.A car can leave a slot by specifying the
//slot number where it was parked.
//6.You should be able to display the
//parking status after each action
//7.showing available spaces and
//filled up spaces.
